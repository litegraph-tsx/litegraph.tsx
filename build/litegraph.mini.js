  ...
  */
    ...
    LGraphNode.prototype.isPointInside = function (x, y, margin, skip_title) {
        ...
        if (this.flags && this.flags.collapsed) {
            ...
            if (isInsideRectangle(x, y, this.pos[0] - margin, this.pos[1] - LiteGraph.NODE_TITLE_HEIGHT - margin, (this._collapsed_width || LiteGraph.NODE_COLLAPSED_WIDTH) +
                2 * margin, LiteGraph.NODE_TITLE_HEIGHT + 2 * margin)) {
                return true;
            }
        }
        ...
        if (node.flags.collapsed) {
            ...
            if (title != null) {
                node._collapsed_width = Math.min(node.size[0], ctx.measureText(title).width +
                    LiteGraph.NODE_TITLE_HEIGHT * 2); //LiteGraph.NODE_COLLAPSED_WIDTH;
