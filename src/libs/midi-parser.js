...
(function () {
  ...
  const MidiParser = {
    ...
    parse(input, _callback) {
      ...
      if (typeof input === 'string') return MidiParser.Base64(input);
      if (input instanceof HTMLElement && input.type === 'file') return MidiParser.addListener(input, _callback);
...
const _MidiParser = _global.MidiParser;
