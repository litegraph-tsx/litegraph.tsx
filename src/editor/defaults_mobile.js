...
LGraphSettings.dialog_close_on_mouse_leave = false; // [false on mobile] better true if not touch device;
...
LGraphSettings.search_hide_on_mouse_leave = false; // [false on mobile] better true if not touch device;
...
PointerSettings.pointerevents_method = 'pointer'; // "mouse"|"pointer" use mouse for retrocompatibility issues? (none found @ now)
